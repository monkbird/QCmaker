...
export interface DiscussionCommand { type:'start'|'message'|'resume'|'finish'|'recover';session_id:string;client_message_id:string;last_event_seq?:number;topic?:string;data_summary?:string;content?:string }
